...
public class AircraftServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AircraftServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AircraftServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html; charset=UTF-8");
        ...
        ValidateAircraft validate = new ValidateAircraft();
        Boolean isExisting = validate.checkUser(reg_no);
        ...
        if (isExisting) {
            ...
            try {
                ...
                String statement = "insert into AIRCRAFT values (?, ?)";
                PreparedStatement ps = con.prepareStatement(statement);

                ps.setString(1, reg_no);
                ps.setString(2, seat_count);
